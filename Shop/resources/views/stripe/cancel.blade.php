...
<head>
    ...
    <title>Stripe Payment Canceled - Vesna's Web Store</title>
...
<body class="antialiased bg-light-gray font-sans">
    ...
    <main class="container-center">
        <div class="bg-white p-8 rounded-xl shadow-md max-w-lg w-full">
            <h1 class="text-4xl font-bold text-orange-500 mb-4">{{ __('stripe_translate.payment_canceled') }}</h1>
            <p class="text-lg text-gray-700 mb-6">{{ $message ?? 'Your Stripe payment has been canceled.' }}</p>
