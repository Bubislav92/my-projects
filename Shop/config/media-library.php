...
return [
    ...
    /*
    * This is the class that is responsible for generating a file path.
    */
    'path_generator' => App\Models\Media\CustomPathGenerator::class, // Ažuriraj namespace ako je drugačiji
