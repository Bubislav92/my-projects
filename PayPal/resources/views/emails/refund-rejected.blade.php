...
<head>
    ...
    <style type="text/css">
        ...
        /* Header */
        .header {
            background-color: #dc3545; /* A danger red for rejection */
            padding: 25px;
            text-align: center;
            color: #ffffff;
        ...
        <div class="email-container">
            ...
            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" class="content">
                <tr>
                    <td>
                        <p>Dear customer,</p>
                        <p>We regret to inform you that your refund request for purchase ID: <strong>{{ $refund->payment->payment_id }}</strong> has been **rejected** by our administration.</p>