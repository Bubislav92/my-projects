...
use App\Mail\ContactForm; // Obavezno importuj
...
class ContactFormController extends Controller
{
    ...
    {
    //        dd($request->all()); // Dodaj ovo privremeno
        $validator = Validator::make($request->all(), [
            'name' => 'required|string|max:255',
            'surname' => 'required|string|max:255',
            'email' => 'required|email|max:255',
            'subject' => 'nullable|string|max:255', // Subject can be option
        ...
        try {
            ...
            Mail::to($recipientEmail)->send(new ContactForm($validatedData));
