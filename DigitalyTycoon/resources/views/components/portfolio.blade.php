    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div class="bg-primary-dark rounded-lg shadow-lg overflow-hidden" data-aos="zoom-in" data-aos-delay="100">
                <img src="https://via.placeholder.com/600x400.png?text=Projekat+1" alt="Projekat 1" class="w-full h-auto">
                <div class="p-6">
            ...
            <div class="bg-primary-dark rounded-lg shadow-lg overflow-hidden" data-aos="zoom-in" data-aos-delay="200">
                <img src="https://via.placeholder.com/600x400.png?text=Projekat+2" alt="Projekat 2" class="w-full h-auto">
                <div class="p-6">
            ...
            <div class="bg-primary-dark rounded-lg shadow-lg overflow-hidden" data-aos="zoom-in" data-aos-delay="300">
                <img src="https://via.placeholder.com/600x400.png?text=Projekat+3" alt="Projekat 3" class="w-full h-auto">
                <div class="p-6">
