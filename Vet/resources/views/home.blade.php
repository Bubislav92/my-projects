            ...
            <div class="max-w-7xl mx-auto text-center px-4 sm:px-6 lg:px-8">
                ...
                <div class="mt-8 flex justify-center">
                    <div class="inline-flex rounded-md shadow">
                        <a href="/appointment" class="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-secondary-500 hover:bg-secondary-600 transition duration-150 ease-in-out">
