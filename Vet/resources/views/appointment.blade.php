...
<body class="bg-white antialiased">
    ...
    <main>
        ...
        <x-appointment.appointment-hero />

        <x-appointment.appointment-form />
        
        <div class="py-12 bg-secondary-700">
            <div class="max-w-4xl mx-auto text-center px-4">
                <p class="text-xl font-medium text-white">
                    <span class="font-extrabold text-secondary-200">For Emergencies:</span> Do not use this form. Please call us immediately at 
                    <a href="tel:+381111234567" class="underline text-white hover:text-secondary-400">+381 11 123 4567</a>.
                </p>
            </div>
        </div>
