...
<head>
    ...
    <title>Прстење | My Jewellery</title>
...
<body class="font-sans antialiased text-dark-gray bg-white">
    ...
    <main class="container mx-auto px-4 py-12">
        <h1 class="text-4xl md:text-5xl font-serif font-bold text-center text-dark-gray mb-10">Прстење</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12">
            <aside class="col-span-1">
                <div class="bg-light-gray p-6 rounded-lg shadow-sm sticky top-28">
                    ...
                    <div class="mb-4">
                        <h4 class="font-sans font-semibold text-subtle-gray mb-2">Величина</h4>
                        <div class="grid grid-cols-4 gap-2">
                            <button class="font-sans text-sm text-subtle-gray hover:text-dark-gray border border-gray-300 rounded-full py-1 px-2 transition-colors duration-300">5</button>
                            <button class="font-sans text-sm text-subtle-gray hover:text-dark-gray border border-gray-300 rounded-full py-1 px-2 transition-colors duration-300">6</button>
                            <button class="font-sans text-sm text-subtle-gray hover:text-dark-gray border border-gray-300 rounded-full py-1 px-2 transition-colors duration-300">7</button>
                            <button class="font-sans text-sm text-subtle-gray hover:text-dark-gray border border-gray-300 rounded-full py-1 px-2 transition-colors duration-300">8</button>
                        </div>
                    </div>
                </div>
            </aside>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    @foreach (range(1, 12) as $item)
                        <div class="bg-white rounded-lg shadow-sm hover:shadow-xl overflow-hidden transform hover:scale-105 transition duration-300 cursor-pointer group">
                            <img src="https://via.placeholder.com/400" alt="Прстен {{ $item }}" class="w-full h-64 object-cover transition-transform duration-300 group-hover:scale-110">
                            <div class="p-4 text-center">
                                <h3 class="font-sans font-semibold text-lg text-dark-gray">Прстен {{ $item }}</h3>
