...
<head>
    ...
    <title>{{ config('app.name', 'My Freelance') }} - Freelancer Dashboard</title>
...
<body class="font-sans antialiased bg-light-gray">
    ...
    <main class="py-10">
        <div class="container mx-auto px-4">
            <h1 class="text-4xl font-bold text-dark-gray mb-8">Freelancer Dashboard</h1>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
                ...
                <div class="bg-white p-6 rounded-lg shadow-md flex items-center justify-between border-l-4 border-primary-orange">
                    <div>
                        ...
                        <h3 class="text-3xl font-bold text-primary-orange">$1,250</h3>
                    </div>
                ...
                <div class="bg-white p-6 rounded-lg shadow-md flex items-center justify-between border-l-4 border-secondary-green">
                    <div>
                        <p class="text-gray-600">Pending Proposals</p>
                        <h3 class="text-3xl font-bold text-secondary-green">5</h3>
                    </div>
                ...
                <div class="bg-white p-6 rounded-lg shadow-md flex items-center justify-between border-l-4 border-primary-orange">
                    <div>
                        ...
                        <h3 class="text-3xl font-bold text-primary-orange">4.9 <span class="text-yellow-500"><i class="fas fa-star text-2xl"></i></span></h3>
                    </div>
            ...
            <div class="bg-white p-8 rounded-lg shadow-md mb-10 border-l-4 border-dark-gray">
                ...
                <ul class="space-y-4">
                    <li class="flex items-start text-gray-700">
                        ...
                        <div>
                            <span class="font-semibold">New message</span> from Client Name regarding "Website Redesign".
                            <span class="text-sm text-gray-500 block">5 minutes ago</span>
                        </div>
                        <a href="#" class="ml-auto text-primary-orange hover:underline transition duration-300">View</a>
                    </li>
                    <li class="flex items-start text-gray-700">
                        <i class="fas fa-check-circle text-secondary-green mt-1 mr-3"></i>
                        <div>
                            Your proposal for "Mobile App Development" was <span class="font-semibold text-secondary-green">accepted!</span>
                            <span class="text-sm text-gray-500 block">1 hour ago</span>
                        </div>
                        <a href="#" class="ml-auto text-primary-orange hover:underline transition duration-300">View Job</a>
                    </li>
                    <li class="flex items-start text-gray-700">
                        <i class="fas fa-dollar-sign text-primary-orange mt-1 mr-3"></i>
                        <div>
                            <span class="font-semibold">$500</span> payment received for "Blog Post Writing".
                            <span class="text-sm text-gray-500 block">Yesterday</span>
                        </div>
                        <a href="#" class="ml-auto text-primary-orange hover:underline transition duration-300">View Transaction</a>
                    </li>
                </ul>
            </div>

            {{-- Активни послови / Пројекти --}}
            <h2 class="text-3xl font-bold text-dark-gray mb-6">Your Active Jobs</h2>
            <div class="bg-white p-8 rounded-lg shadow-md mb-10 overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-dark-gray">Website Redesign</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">Acme Inc.</td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-blue-100 text-blue-800">In Progress</span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">July 20, 2025</td>
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm text-secondary-green font-semibold">$1,500</td>
                        ...
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-dark-gray">Logo Design & Branding</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">Startup X</td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-yellow-100 text-yellow-800">Review Pending</span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">June 28, 2025</td>
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm text-secondary-green font-semibold">$750</td>
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <a href="#" class="text-primary-orange hover:text-orange-700 mr-4">View</a>
                                <a href="#" class="text-secondary-green hover:text-green-700">Message</a>
                            </td>
                        </tr>
                        {{-- Додај још редова за активне послове --}}
                    </tbody>
                </table>
            </div>
            ...
            <div class="bg-orange-100 border-l-4 border-primary-orange text-orange-700 p-4 rounded-lg mb-8" role="alert">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-sm">Complete your profile to increase your chances of getting hired. You are <span class="font-bold">75%</span> complete.</p>
                    </div>
                    <a href="#" class="ml-auto bg-primary-orange text-white px-4 py-2 rounded-md hover:bg-orange-700 transition duration-300">Complete Profile</a>
                </div>
            </div>
